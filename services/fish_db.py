...
FISH_DB: tuple[Fish, ...] = (
    ...
    # ==================== Новые виды (из базы ихтиофауны КК) ====================
    Fish(
        name="Пеленгас",
        kind="мирная",
        active_months=(5, 6, 7, 8, 9, 10),
        ...
        gear=("донка/фидер",),
        baits=("нереис (морской червь)", "опарыш", "креветка"),
        water_temp_c=(12.0, 28.0),
        habitats=("лиман", "водоём"),
        best_time="утро",
        tip=(
            "Донка с грузом 80–120 г, крючок №6–8, поводок 0.25. "
            "Лучшая наживка — нереис (морской червь). Ищи косяки "
            "по всплескам. В лиманах — на дальний заброс."
        ),
        latin_names=("Liza haematocheila", "Mugil soiuy"),
    ),
    Fish(
        name="Ставрида",
        kind="хищная",
        ...
        peak_months=(9, 10, 11),
        gear=("спиннинг", "поплавок"),
        baits=("самодур", "микроджиг", "креветка", "кусочек рыбы"),
        water_temp_c=(10.0, 26.0),
        habitats=("водоём",),
        best_time="день",
        tip=(
            "Самодур (гирлянда 5–8 крючков с блёстками) — классика. "
            "Забрасывай с пирса и веди рывками. С берега — "
            "микроджиг 2–4 г или поплавок с креветкой."
        ),
        latin_names=("Trachurus mediterraneus",),
    ),
    Fish(
        name="Барабулька",
        kind="мирная",
        ...
        peak_months=(7, 8, 9),
        gear=("донка/фидер", "поплавок"),
        baits=("нереис", "креветка", "мясо мидии"),
        water_temp_c=(14.0, 26.0),
        habitats=("водоём",),
        best_time="утро и вечер",
        tip=(
            "Донка лёгкая, крючок №10–12, поводок 0.14. "
            "Нереис или креветка на песчаном дне. Барабулька "
            "ходит стаями — поймал одну, жди следующих."
        ),
        latin_names=("Mullus barbatus",),
    ),
    Fish(
        name="Кефаль",
        kind="мирная",
        ...
        peak_months=(5, 6, 7, 8),
        gear=("поплавок", "донка/фидер"),
        baits=("хлеб", "нереис", "тесто", "креветка"),
        water_temp_c=(12.0, 28.0),
        habitats=("лиман", "водоём"),
        best_time="утро",
        tip=(
            "Поплавок с дальним забросом, крючок №8–10. "
            "Кефаль осторожна — тонкий поводок 0.14, "
            "маленький крючок. Прикорми хлебом с маслом."
        ),
        latin_names=("Mugil cephalus", "Chelon auratus", "Chelon saliens"),
    ),
    Fish(
        name="Сарган",
        kind="хищная",
        active_months=(3, 4, 5, 9, 10, 11, 12, 1, 2),
        peak_months=(10, 11, 12),
        gear=("поплавок", "спиннинг"),
        baits=("кусочек рыбы", "креветка", "куриное мясо", "блесна"),
        water_temp_c=(8.0, 20.0),
        habitats=("водоём",),
        best_time="день",
        tip=(
            "Длинная поплавочная снасть, поводок из флюорокарбона. "
            "Сарган берёт жадно, но у него костлявый клюв — "
            "подсекай резко. Ловится с пирсов и причалов."
        ),
        latin_names=("Belone belone",),
    ),
    Fish(
        name="Луфарь",
        kind="хищная",
        ...
        peak_months=(9, 10, 11),
        gear=("спиннинг",),
        baits=("пилькер", "воблер", "колебалка", "силикон"),
        water_temp_c=(12.0, 24.0),
        habitats=("водоём",),
        best_time="утро и вечер",
        tip=(
            "Агрессивный хищник! Спиннинг с пилькером 20–40 г, "
            "быстрая проводка. Обязательно металлический поводок — "
            "зубы как бритва. Ищи «бой» на поверхности."
        ),
        latin_names=("Pomatomus saltatrix",),
    ),
    Fish(
        name="Камбала",
        kind="хищная",
        ...
        gear=("донка/фидер",),
        baits=("креветка", "нереис", "кусочек рыбы", "мясо мидии"),
        water_temp_c=(6.0, 22.0),
        habitats=("лиман", "водоём"),
        best_time="утро и вечер",
        tip=(
            "Донка с грузом 60–100 г, крючок №4–6. Камбала "
            "лежит на дне — веди приманку медленно, с паузами. "
            "Лучше всего — после шторма, когда муть поднимается."
        ),
        latin_names=("Scophthalmus maeoticus", "Platichthys flesus"),
    ),
    Fish(
        name="Скорпена",
        kind="хищная",
        ...
        gear=("донка/фидер", "поплавок"),
        baits=("креветка", "кусочек рыбы", "нереис", "мясо мидии"),
        water_temp_c=(8.0, 26.0),
        habitats=("водоём",),
        best_time="ночь",
        tip=(
            "Морской ёрш. Ловится у камней и скал, особенно ночью. "
            "⚠️ ЯДОВИТЫЕ ШИПЫ — снимай с крючка только плоскогубцами! "
            "Зато уха из скорпены — деликатес."
        ),
        latin_names=("Scorpaena porcus",),
    ),
    Fish(
        name="Ласкирь",
        kind="мирная",
        ...
        peak_months=(7, 8, 9),
        gear=("поплавок", "донка/фидер"),
        baits=("креветка", "нереис", "мясо мидии", "хлеб"),
        water_temp_c=(14.0, 26.0),
        habitats=("водоём",),
        best_time="день",
        tip=(
            "Морской карась. Лови у скал и пирсов на поплавок, "
            "крючок №10–12. Прикорми хлебом — стая подойдёт. "
            "Осторожен, поводок 0.12–0.14."
        ),
        latin_names=("Diplodus annularis",),
    ),
    Fish(
        name="Форель",
        kind="хищная",
        ...
        gear=("спиннинг", "поплавок"),
        baits=("воблер", "вертушка", "червь", "малёк"),
        water_temp_c=(4.0, 18.0),
        habitats=("водоём",),
        best_time="утро",
        tip=(
            "Ультралайт спиннинг, вертушка №0–1 или микровоблер. "
            "Ищи за камнями на перекатах. ⚠️ На реках ЧП (Мзымта, "
            "Шахе, Псезуапсе) ловля лососевых ЗАПРЕЩЕНА круглогодично!"
        ),
        latin_names=("Salmo trutta",),
    ),
    Fish(
        name="Подуст",
        kind="мирная",
        ...
        peak_months=(5, 6, 7),
        gear=("поплавок", "донка/фидер"),
        baits=("червь", "опарыш", "перловка", "тесто"),
        water_temp_c=(10.0, 22.0),
        habitats=("река", "канал"),
        best_time="день",
        tip=(
            "Ищи на перекатах с каменистым дном. Поплавок в "
            "проводку по течению, крючок №12–14. Кубанский подуст — "
            "эндемик, нечастый вид."
        ),
        latin_names=("Chondrostoma kubanicum", "Chondrostoma colchicum"),
    ),
    Fish(
        name="Усач",
        kind="мирная",
        ...
        peak_months=(6, 7, 8),
        gear=("донка/фидер", "поплавок"),
        baits=("червь", "опарыш", "кукуруза", "сыр"),
        water_temp_c=(12.0, 24.0),
        habitats=("река",),
        best_time="утро и вечер",
        tip=(
            "Донка у дна на перекатах и каменистых участках. "
            "Усач кубанский — сильная рыба, тянет хорошо. "
            "Крючок №6–8, поводок 0.20."
        ),
        latin_names=("Barbus kubanicus", "Barbus"),
    ),
    Fish(
        name="Пескарь",
        kind="мирная",
        ...
        peak_months=(5, 6, 7),
        gear=("поплавок",),
        baits=("мотыль", "червь", "опарыш"),
        water_temp_c=(4.0, 22.0),
        habitats=("река", "канал", "водоём"),
        best_time="день",
        tip=(
            "Лёгкая поплавочка у дна, крючок №16–18. "
            "Пескарь — отличный живец для хищника. "
            "Ищи на песчаном и гравийном дне."
        ),
        latin_names=("Gobio gobio", "Gobio"),
    ),
)
